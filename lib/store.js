...
// Coba baca env vars tanpa prefix, lalu fallback ke prefix KV_URL_
// (Vercel otomatis tambahkan prefix nama database KV)
...
const kv = isValidUrl && REST_TOKEN ? new Redis({ url: REST_URL, token: REST_TOKEN }) : null;
